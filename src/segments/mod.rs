...
impl SegmentCondition {
    pub fn matches_trait_value(&self, trait_value: &featurestate_value::FeatureStateValue) -> bool {
        return match trait_value.value_type {
            featurestate_value::FeatureStateValueType::Integer => {
...
mod tests {
    ...
    fn segment_condition_matches_trait_value() {
        ...
        fn check(
            operator: &str,
            trait_value: &str,
            trait_value_type: featurestate_value::FeatureStateValueType,
            value: &str,
            result: bool,
        ) {
            let trait_value = featurestate_value::FeatureStateValue {
